...
// 10/21/2025 Arri - updated for ALFA skills
...
string GetNVPValue(string sNVPList, string sName);
string RemoveNVP(string sNVPList, string sName);
...
int GetSkillConstant(int nSkill)
{
	...
	switch (nSkill)	
	{
        ...
        case 17:     // PERFORM  KEYBOARDS
            nSkillVal = SKILL_PERFORMKEYBOARDS;
            break;
        case 18:     // RIDE
       ...
       //     break;
		...
		case 55:     // KNOWLEDGE LOCAL
            ...
            break;
	   case 56:     // CRAFT BOWMAKING
            nSkillVal = SKILL_CRAFT_BOWMAKING;
            break;
	}  
...
string GetNVPValue(string sNVPList, string sName)
{
	...
	{
		oNameValuePair = GetNameValuePairStruct(sNameValuePair);
...
string RemoveNVP(string sNVPList, string sName)
{
	...
	string sNameValuePair = sName + "=" + sValue;
